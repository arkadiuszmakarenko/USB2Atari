...
typedef struct _HIDDescriptor
{
  ...
  hid_report_t						RptDesc; //place to hold HID report descriptor
}
HID_DescTypeDef;
...
typedef enum
{
  IFACE_INIT = 0,
  IFACE_READHID,
  IFACE_READHIDRPTDESC,
  IFACE_INITSUBCLASS,
  IFACE_INITENDPNT,
  IFACE_SELECTIFACE
}USBH_IfaceInitStatusTypeDef;
...
extern USBH_ClassTypeDef  HID_ClassHS;
#define USBH_HID_CLASS    &HID_Class
#define USBH_HID_CLASSHS    &HID_ClassHS
